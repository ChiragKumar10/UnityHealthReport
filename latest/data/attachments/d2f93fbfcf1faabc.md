...
- Name: provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts >> Billing > Enrollments — claim workflow >> claim page auto-fill — opening the dialog pre-populates all required fields from the patient billing row
- Location: tests/web/provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts:192:9
