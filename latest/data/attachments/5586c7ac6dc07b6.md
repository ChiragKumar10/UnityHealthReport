...
```
Error: Patient row for Champlin, Maryam should appear in Billing > Enrollments > RTM

expect(locator).toBeVisible() failed

Locator: locator('//*[normalize-space()="Champlin, Maryam"]/ancestor::*[count(./*) >= 5][1]').first()
Expected: visible
Timeout: 15000ms
Error: element(s) not found

Call log:
  - Patient row for Champlin, Maryam should appear in Billing > Enrollments > RTM with timeout 15000ms
  - waiting for locator('//*[normalize-space()="Champlin, Maryam"]/ancestor::*[count(./*) >= 5][1]').first()
...
- main:
  ...
  - textbox "Search Patient": Champlin
