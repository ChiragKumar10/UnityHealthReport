...
- Name: provider-portal/monitoring/billing-enrollments-paid-status-workflow.spec.ts >> Billing > Enrollments — paid-status workflow >> update drawer shows existing data — opening Update on a paid row displays the saved Paid Status + Paid Date + Claim Number
- Location: tests/web/provider-portal/monitoring/billing-enrollments-paid-status-workflow.spec.ts:256:9
