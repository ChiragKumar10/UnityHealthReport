...
- Name: provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts >> Billing > Enrollments — claim workflow >> claim generation E2E — pre-filled fields verified, then claim submitted, status flips Submitted
- Location: tests/web/provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts:245:9
