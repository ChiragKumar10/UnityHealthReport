...
- Name: provider-portal/monitoring/billing-enrollments-paid-status-workflow.spec.ts >> Billing > Enrollments — paid-status workflow >> paid status display — PAID STATUS and PAID DATE cells display exact saved values
- Location: tests/web/provider-portal/monitoring/billing-enrollments-paid-status-workflow.spec.ts:220:9
