        ...
        - region [ref=f1e1707]:
          - generic [ref=f1e1710]:
            - generic [ref=f1e1712]:
              ...
              - generic [ref=f1e1717]:
                - combobox "Search" [ref=f1e1718]: Wintheiser, Oliver
                - button "Open" [ref=f1e1720] [cursor=pointer]
                - group
            - generic [ref=f1e1723]:
              - generic [ref=f1e1724]: Date Of Birth*
              - generic [ref=f1e1727]:
                - button "Choose date, selected date is Jun 23, 2023" [ref=f1e1729] [cursor=pointer]
                - textbox "MM-DD-YYYY" [ref=f1e1732]: 06-23-2023
                - group
            - generic [ref=f1e1733]:
              ...
              - generic [ref=f1e1736]:
                - generic [ref=f1e1739]:
                  ...
                  - group
                - textbox "Enter Number" [ref=f1e1742]: 926-790-9574
            - generic [ref=f1e1743]:
