...
```
Error: Patient "Nikolaus" (CCM) should appear in the Active section after Move to Active

expect(locator).toBeVisible() failed

Locator: locator('//div[contains(@class,"css-1hhl13x")] | //div[(./div[normalize-space()="RPM"] or ./div[normalize-space()="RTM"] or ./div[normalize-space()="CCM"] or ./div[normalize-space()="PCM"]) and count(./div) >= 6]').filter({ hasText: 'Nikolaus' }).filter({ hasText: 'CCM' }).first()
Expected: visible
Timeout: 30000ms
Error: element(s) not found

Call log:
  - Patient "Nikolaus" (CCM) should appear in the Active section after Move to Active with timeout 30000ms
  - waiting for locator('//div[contains(@class,"css-1hhl13x")] | //div[(./div[normalize-space()="RPM"] or ./div[normalize-space()="RTM"] or ./div[normalize-space()="CCM"] or ./div[normalize-space()="PCM"]) and count(./div) >= 6]').filter({ hasText: 'Nikolaus' }).filter({ hasText: 'CCM' }).first()
...
- main:
  ...
  - button "Clear"
  - combobox "Chronic Care Management (CCM)"
  - combobox "Active"
  - button "Add Enrollment"
  - text: SR NO NAME ▲ PROGRAM ENROLLED DATE STATUS DIAGNOSIS CODES(ICD) CARE MANAGER PROVIDER LOCATION ACTION 01 Pagac, Elvira CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 02 Weissnat, Baby CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 03 Corwin, Trycia CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 04 Kilback, Richmond CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 05 Will, Felipe CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 06 Ryan, Melyna CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 07 Ledner, Tricia CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 08 Gottlieb, Jamal CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 09 Collins, Cornelius CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 10 Smith, Modesto CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 11 Berge, Lela CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 12 Brakus, Mark CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 13 HegmannCole, Charlene CCM 08-24-2026
  - heading "active" [level=6]
  - text: A111-Test ... +1 Autofirstarnnuw Autolastarnnuw Anny Vate Automation 14 KassulkeKlein, Ricardo CCM 08-24-2026
  - heading "active" [level=6]
