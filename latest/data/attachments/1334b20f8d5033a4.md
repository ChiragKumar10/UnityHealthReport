...
- Name: provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts >> Billing > Enrollments — claim workflow >> submission confirmation — row CLAIM STATUS flips Submitted, row stays visible, bucket-tile count increments after reload
- Location: tests/web/provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts:354:9
