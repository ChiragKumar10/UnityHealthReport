...
- Name: provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts >> Billing > Enrollments — claim workflow >> mandatory validation — submitting with both fields empty blocks submission and surfaces the right message(s)
