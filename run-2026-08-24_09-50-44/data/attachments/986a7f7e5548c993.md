...
- Name: provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts >> Billing > Enrollments — claim workflow >> submit claim + mark paid E2E — N/A → Submitted → Paid
- Location: tests/web/provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts:406:9
