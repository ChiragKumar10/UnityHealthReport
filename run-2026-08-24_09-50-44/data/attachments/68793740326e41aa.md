...
- Name: provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts >> Billing > Enrollments — claim workflow >> mandatory validation — submitting with only Claim Number filled blocks submission and surfaces the right message(s)
- Location: tests/web/provider-portal/monitoring/billing-enrollments-claim-workflow.spec.ts:305:13
